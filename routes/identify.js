...
router.post("/identify", async (req, res) => {
  ...
  try {
    ...
    // Find matching contacts by email or phoneNumber
    ...
    // Convert any other primary to secondary linked to oldest primary
    ...
    // Fetch all related contacts after insertions/updates
